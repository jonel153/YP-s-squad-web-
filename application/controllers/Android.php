...
class Android extends CI_Controller{
	...
	public function login_process(){
		...
		/*if($_SERVER['REQUEST_METHOD'] == 'POST'){*/
			...
			$result = $this->login->check_credentials($email, $password);
	...
	public function third_check(){
		...
		$party_id = $this->_clean_data($this->input->post('id'));
			...
			if($check_id['result'] == TRUE){
				...
				if($result == TRUE){
					...
					if($this->input->post('sms') == 'yes'){
						...
						$sms_message = 'Hi ' . $name . ' this to inform you that your check is preparing now. Thank you!';
			...
			if($check_id['result'] == TRUE){
				...
				if($result == TRUE){
					...
					if($this->input->post('sms') == 'yes'){
						$number = $check_id['info']->party_number;
						$name = $check_id['info']->party_name;
						$sms_message = 'Hi ' . $name . ' this to inform you that your check is in transferring now. Thank you!';
						$this->sms($number, $sms_message);
					}
			...
			if($check_id['result'] == TRUE){
				...
				if($result == TRUE){
					...
					if($this->input->post('sms') == 'yes'){
						$number = $check_id['info']->party_number;
						$name = $check_id['info']->party_name;
						$sms_message = 'Hi ' . $name . ' this to inform you that your check has been claimed now. Thank you!';
						$this->sms($number, $sms_message);
					}
