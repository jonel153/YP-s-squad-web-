...
class Admin_model extends CI_Model {
	...
	public function get_account(){
		$query = $this->db->query('SELECT * FROM tblcompany, tblaccount WHERE tblcompany.company_id=tblaccount.company_id');
	...
	public function check_party($tbl, $where){
		...
		if($num > 0){
			...
			$msg = '<div id="login_status" class="alert alert-danger">Error payee name not exist!</div>';
