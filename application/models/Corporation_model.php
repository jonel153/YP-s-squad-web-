...
class Corporation_model extends CI_Model {
	...
	public function function_add_thirdparty($id)
	{
		$Company_ID = $id;
	...
	public function mythird_party($id)
	{
		$select_query = $this->db->query("SELECT * FROM tblthirdparty, tblcompany WHERE tblthirdparty.company_id=tblcompany.company_id AND tblcompany.company_id=" . $id);
