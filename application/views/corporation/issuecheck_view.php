        ...
        <div class="modal fade" id="modal-upload" tabuser="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-sm">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">                            
                        <form method="POST" enctype="multipart/form-data" action="<?php echo base_url();?>corporation/upload-check" id="shipment_form">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="account" id="account">
                                    ...
                                    foreach ($account as $row):
                                        $id= strtr(
                                            $this->encrypt->encode($row->ACCOUNT_ID),
                                            array(
                                                '+' => '.',
                                                '=' => '-',
                                                '/' => '~'
                                    ...
                                    ?>
                                    <option value="<?=$id?>"><?=$row->ACCOUNT_NUMBER?></option>
                                    <?php endforeach;?>
                                </select>
                            </div>
